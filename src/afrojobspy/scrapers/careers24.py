...
class Careers24Scraper(BaseScraper):
    """Scraper for Careers24 (South Africa)"""
    def __init__(self, proxies: Optional[List[str]] = None):
        super().__init__(proxies=proxies)
        self.base_url = "https://www.careers24.com/jobs/"
    ...
    def scrape(self, search_term: str = "", location: str = "", results_wanted: int = 10) -> List[JobPost]:
        ...
        try:
            ...
            cards = soup.select("div.job_listing, div.job-card, article, div.element")
            ...
            for card in cards:
                ...
                if not job_url.startswith("http"):
                    job_url = "https://www.careers24.com" + job_url if job_url.startswith("/") else f"https://www.careers24.com/{job_url}"
                ...
                company = "Careers24 Partner"
                comp_elem = card.select_one(".company-name, .employer")
                if comp_elem:
            ...
            logger.error(f"Careers24 scrape error: {e}")
        return jobs