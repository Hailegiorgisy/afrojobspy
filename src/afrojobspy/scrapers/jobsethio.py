...
class JobsEthioScraper(BaseScraper):
    """Scraper for JobsEthio"""
    def __init__(self, proxies: Optional[List[str]] = None):
        super().__init__(proxies=proxies)
        self.base_url = "https://www.jobsethio.com"
    ...
    def scrape(self, search_term: str = "", location: str = "", results_wanted: int = 10) -> List[JobPost]:
        ...
        try:
            ...
            cards = soup.select("div.job-card, article, div.job-item, a[href*='/job']")
            ...
            for card in cards:
                ...
                if not job_url.startswith("http"):
                    job_url = "https://www.jobsethio.com" + job_url if job_url.startswith("/") else f"https://www.jobsethio.com/{job_url}"
            ...
            logger.error(f"JobsEthio scrape error: {e}")
        return jobs